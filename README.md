### New extension for Google Maps

Use [Custom Shortcuts for Google Maps](https://github.com/yusacetin/google_maps_shortcuts) for Google Maps instead, it's a JavaScript based browser extension so it works much more reliably.
